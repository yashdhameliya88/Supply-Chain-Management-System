...
//                                            echo "<option value='" . $data['stateId'] . "' selected>" . $data['stateName'] . "</option>";  // displaying data in option menu
//                                        } else {
...
//            mysqli_close($connect);
        ...
        if ($emailId==$rowexists['emailId'])
        {
            echo '<script type="text/javascript"> 
                            ...
                            window.location.href = "./SupplierMainAdd.php";
                            </script>;';
        }
        }
        else
        {     
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                echo '<h1>You already added one main supplier</h1>';
            } else {
                $code = rand(1111, 9999);
                if (isset($_POST['VerifyOtp'])) {
                    if (isset($_POST['mail'])) {
...
//                        $connect = mysqli_connect("localhost", "root", "root", "SCMS") or die("Couldn't Connect!!");
                            ...
                            $sql2 = "INSERT INTO tblSupplier (`supplierLevel`,`userId`,`status`) VALUES (0," . mysqli_insert_id($connect) . ",'Not Approved')";
