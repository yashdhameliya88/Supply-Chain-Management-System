...
<html>
    ...
    <body>
        ...
        <div>
            ...
            $selectquery = "select p.*,u.*,o.* from tblProduct p,tblUser u,tblOrders o where p.productId=o.productId and u.userId=o.buyerId and o.sellerId=$UserId and o.status='Delivered'";
